...
#k1 = ConvLSTM2D(4, (3,3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.1)(x4)
...
d1 = TimeDistributed(Conv2DTranspose(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(x6)
...
predNet.save('D:/8_Article2021_ImageBased/ImageBasedPaper/GoogleImage/CIPNet.h1')
#%%
...
predict1 = predict.reshape(702, 256*512)
...
predict_n = predict_n.reshape(702, 256, 512, 3)
...
y_test1 = y_test1.reshape(702, 256*512)
#%%
