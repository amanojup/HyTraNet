...
k1 = ConvLSTM2D(4, (3,3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.1)(x5)
...
d2 = TimeDistributed(Conv2DTranspose(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(k2)
...
predNet.save('D:/8_Article2021_ImageBased/ImageBasedPaper/GoogleImage/KkNet4.h15')
#%%
