# -*- coding: utf-8 -*-
"""
Created on Tue Aug 16 01:40:27 2022
...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 25 12:31:40 2022
...
data_path = r'D:\8_Article2021_ImageBased\ImageBasedPaper\GoogleImage\Rough'
...
for img in img_list:
    ...
    ing = input_img.reshape(256, 512,3)
    #cv2.imshow('o',ing)
    #cv2.waitKey(0)
    #%%
...
x4 = TimeDistributed(Conv2D(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(x3)
x4 = TimeDistributed(BatchNormalization())(x4)
x4 = TimeDistributed(Dropout(0.1))(x4)
x4 = TimeDistributed(Conv2D(4, (3, 3), strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform'))(x4)
x4 = TimeDistributed(BatchNormalization())(x4)
x4 = TimeDistributed(Dropout(0.1))(x4)

x5 = TimeDistributed(Conv2D(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(x4)
x5 = TimeDistributed(BatchNormalization())(x5)
x5 = TimeDistributed(Dropout(0.1))(x5)
x5 = TimeDistributed(Conv2D(4, (3, 3), strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform'))(x5)
x5 = TimeDistributed(BatchNormalization())(x5)
x5 = TimeDistributed(Dropout(0.1))(x5)

x6 = TimeDistributed(Conv2D(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(x5)
x6 = TimeDistributed(BatchNormalization())(x6)
x6 = TimeDistributed(Dropout(0.1))(x6)
x6 = TimeDistributed(Conv2D(4, (3, 3), strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform'))(x6)
x6 = TimeDistributed(BatchNormalization())(x6)
x6 = TimeDistributed(Dropout(0.1))(x6)

k1 = ConvLSTM2D(4, (3,3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.1)(x6)
...
#k3= ConvLSTM2D(4, (3,3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.1)(k2)
#k3 = BatchNormalization()(k3)
#k4= ConvLSTM2D(4, (3,3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.1)(k3)
#k4 = BatchNormalization()(k4)

d1 = TimeDistributed(Conv2DTranspose(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(k2)
d1 = TimeDistributed(BatchNormalization())(d1)
d1 = Concatenate()([d1,x5])
d1 = TimeDistributed(Dropout(0.1))(d1)
d1 = TimeDistributed(Conv2D(4, (3, 3), strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform'))(d1)
d1 = TimeDistributed(BatchNormalization())(d1)
d1 = TimeDistributed(Dropout(0.1))(d1)

d2 = TimeDistributed(Conv2DTranspose(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(d1)
d2 = TimeDistributed(BatchNormalization())(d2)
d2 = Concatenate()([d2,x4])
d2 = TimeDistributed(Dropout(0.1))(d2)
d2 = TimeDistributed(Conv2D(4, (3, 3), strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform'))(d2)
d2 = TimeDistributed(BatchNormalization())(d2)
d2 = TimeDistributed(Dropout(0.1))(d2)

d3 = TimeDistributed(Conv2DTranspose(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(d2)
d3 = TimeDistributed(BatchNormalization())(d3)
d3 = Concatenate()([d3,x3])
d3 = TimeDistributed(Dropout(0.1))(d3)
d3 = TimeDistributed(Conv2D(4, (3, 3), strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform'))(d3)
d3 = TimeDistributed(BatchNormalization())(d3)
d3 = TimeDistributed(Dropout(0.1))(d3)

d4 = TimeDistributed(Conv2DTranspose(4, (2,2), strides=(2,2),activation='relu', padding='valid', kernel_initializer='he_uniform'))(d3)
...
#predNet = multi_gpu_model(predNet, gpus= 0)
predNet.compile(optimizer= 'adam', loss = 'categorical_crossentropy', metrics = ['accuracy'])
predNet.fit(x_train,y_train1, epochs=45, batch_size = 32, validation_data=(x_vali, y_vali1))
predNet.save('D:/8_Article2021_ImageBased/ImageBasedPaper/GoogleImage/KkNetAll.h30')
#%%
#predNet1=load_model('D:\8_Article2021_ImageBased\ImageBasedPaper\GoogleImage\kkNet.h5')
#%%
""" TEST data x and Y"""
test_data_dir = r'D:\8_Article2021_ImageBased\ImageBasedPaper\GoogleImage\Rough'
test_holder1 = []
...
predict1 = predict.reshape(len(x_test), 256*512)
#predict = predict.reshape(y_vali.shape[0],1, row, col, 1)
predict_n=np.zeros(shape=(predict.shape[0],3,256,512,3))
...
predict_n = predict_n.reshape(x_test.shape[0], 256, 512, 3)
...
y_test1 = y_test1.reshape(len(x_test), 256*512)
#%%
...
#df1.to_csv('test_MproS5.csv',index=False)
# save the prediction values and the real values
#np.savetxt( 'pre.txt',y1_pre1 )
#df = pd.DataFrame(predict1)
#df.to_csv('pre_MproS5.csv',index=False)